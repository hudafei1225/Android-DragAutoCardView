...
public class CardAnimator {
    ...
    private static final int REMOTE_DISTANCE = 2000;
    private int mBackgroundColor;
    public ArrayList<View> mCardCollection;
    private float mRotation;
    private HashMap<View, RelativeLayout.LayoutParams> mLayoutsMap;
    private RelativeLayout.LayoutParams[] mRemoteLayouts = new RelativeLayout.LayoutParams[5];
    ...
    private void setupRemotes() {
        ...
        mRemoteLayouts[4] = getMoveParams(topView, -REMOTE_DISTANCE, REMOTE_DISTANCE);
    ...
    public void drag(MotionEvent e1, MotionEvent e2, float distanceX,
        ...
        float rotation_coefficient = 40f;
